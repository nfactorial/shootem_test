pc.script.attribute('range', 'number', 1, {
    ...
    max: 5,
    displayName: 'Range',
    description: 'Distance the tower can fire.'
});
...
pc.script.attribute('maxHealth', 'number', 100, {
    ...
    description: 'The maximum health value for this tower.'
});

pc.script.create('tower_controller', function (app) {
    var TowerController = function (entity) {
        this.entity = entity;
        this.opponent = null;
